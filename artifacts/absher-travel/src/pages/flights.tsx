  ...
  return (
    ...
    >
      ...
      <div className="w-28 h-28 rounded-full bg-[#D4AF37]/15 border-2 border-[#D4AF37]/30 flex items-center justify-center mb-8">
        <Plane className="w-14 h-14 text-[#D4AF37]" />
      </div>
      ...
      <p className="text-[#D4AF37] font-bold text-lg mb-4 tracking-widest uppercase">
        {ar ? "حجز رحلات الطيران" : "Flight Booking"}
      </p>
      <p className="text-slate-300 text-base leading-relaxed max-w-md mb-10">
        {ar
          ? "نعمل على إطلاق خدمة حجز الرحلات الجوية بأفضل الأسعار وأكثر الخيارات تنوعاً. ترقبوا إطلاقها قريباً."
          : "We're working on bringing you the best flight booking experience with competitive prices. Stay tuned for the launch."}
      </p>
